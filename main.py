...
file_path = 'csv_files/german_breeds.csv'
...
#This line of code adds a header, divided with a rainbow line (because everyone loves a pop of color!)
st.header('This is app will predict the breed of a dog!', divider = 'rainbow',)

#This was the old code we used for the header, which is why I commented it out
#st.write(
    #"""
    # Dog Breed App
...
img0 = Image.open('Images/German-Longhaired-Pointer.jpeg')
img1 = Image.open('Images/German-Pinscher.jpeg')
img2 = Image.open('Images/German-Shepherd.jpeg')
img3 = Image.open('Images/German-Shorthaired-Pointer.jpeg')
img4 = Image.open('Images/German-Wirehaired-Pointer.jpeg')
